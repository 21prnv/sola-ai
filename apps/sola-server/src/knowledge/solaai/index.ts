...
In 2021, Sola AI underwent a historic transformation:
...
- Governed by FOX token holders via Sola AI DAO
- Treasury: 567 million FOX tokens (56.7% of total supply)
- Actively generating revenue through protocol fees

## Mission

Sola AI's mission is to provide a powerful, community-owned, self-custody, multi-chain crypto platform for the world. The platform emphasizes:
...
The Sola AI DAO offers unique benefits to contributors:
...
- **Governance Platform:** Snapshot (snapshot.box/#/s:sola-aidao.eth)
- **Discussion Forum:** forum.sola-ai.com
...
Sola AI is a multichain crypto home base—a community-owned, private, non-custodial platform for trading, tracking, earning, and exploring crypto across 19 blockchain networks.
...
- Note: Fiat on/off-ramp providers (Coinbase, Banxa, OnRamper, Mt Pelerin) may require KYC per regulatory requirements, but Sola AI itself does not
...
### Multi-Chain Support
Sola AI supports 19 blockchain networks:
...
### Supported Wallets
Sola AI can be used with various wallet providers:
- MetaMask
- WalletConnect-compatible wallets
- Native Sola AI mobile app (iOS/Android)
...
- Quote comparison across multiple providers`,
  ...
  swappers: `# Sola AI Swap Providers

Sola AI integrates **12 swap providers and aggregators** to offer users the best rates and widest asset coverage across all supported chains.
...
- **Capabilities:**
  ...
  - Powers Sola AI's limit orders feature
...
- **Note:** This is how Sola AI accesses 40+ DeFi protocols without direct integration of each
...
While Sola AI directly integrates 12 swap providers, the **Portals integration** enables access to 40+ DeFi protocols including:
...
This means users can enter/exit complex DeFi positions in one click without Sola AI directly integrating each protocol.`,

  chains: `# Supported Blockchain Networks

Sola AI supports **19 blockchain networks** across multiple ecosystems, enabling true multi-chain functionality.
...
Sola AI's multi-chain support enables:
...
Sola AI provides access to **7 different staking and yield-earning opportunities**, allowing users to put their crypto to work.
...
- **Chain:** Arbitrum One
- **Stake:** FOX tokens
- **Earn:** Share of Sola AI DAO protocol revenue (distributed in USDC)
...
- No lockup period
- Integrates with Sola AI DAO revenue streams
...
- Complete UI in Sola AI platform
...
All staking opportunities are fully integrated into Sola AI's UI with deposit, withdraw, claim, and tracking functionality.`,

  'fox-token': `# FOX Token

FOX is the governance and utility token of the Sola AI DAO.
...
### 1. Governance
- Vote on Sola AI DAO proposals
- Participate in protocol decision-making
- Influence treasury management
- Voting platform: Snapshot (snapshot.box/#/s:sola-aidao.eth)
...
The Sola AI DAO controls a significant treasury:
...
- Recipients: Sola AI customers, DeFi users, protocol participants
...
- Swap for FOX on Sola AI platform
...
- Use Sola AI's multi-chain swap functionality
...
- **Governance:** snapshot.box/#/s:sola-aidao.eth
- **Forum:** forum.sola-ai.com
- **Discord:** discord.gg/sola-ai
- **X (Twitter):** x.com/sola-ai

## Listing FOX

Exchanges and apps interested in listing FOX can contact:
- **Email:** listings@sola-aidao.org
- Provide liquidity, trading pairs, and community access to FOX`,

  features: `# Sola AI Platform Features
...
Sola AI integrates **4 fiat ramp providers** for buying and selling crypto with traditional currency:
...
- **Important:** KYC requirements vary by provider and are managed by the provider, not Sola AI
...
- Sola AI never has access to funds
- Non-custodial throughout entire platform

### No KYC (for Sola AI)
- No identity verification required for Sola AI features
- Privacy-preserving
...
- Never shares private keys`,
  ...
  'mobile-app': `# Sola AI Mobile App

Sola AI offers native mobile apps for iOS and Android, providing the full Sola AI experience on mobile devices.
...
The mobile app provides complete access to all Sola AI features:
...
- Use Sola AI mobile as your wallet for any dApp
...
| WalletConnect | Use Sola AI as wallet for any dApp |
...
- **No KYC:** No identity verification for Sola AI features
