...
if (!TURNSTILE_SECRET) {
  console.warn(
    '[turnstile] TURNSTILE_SECRET_KEY is not set — bot protection on /api/chat will be skipped.'
  )
}
...
export async function verifyTurnstileToken(token: string | undefined, ip: string | undefined): Promise<TurnstileResult> {
